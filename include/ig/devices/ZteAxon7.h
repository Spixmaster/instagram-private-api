#ifndef IG_DEVICES_ZTE_AXON_7_H
#define IG_DEVICES_ZTE_AXON_7_H
...
namespace ig
{
	/**
	 * @class ZteAxon7
	 * @brief This class represents the ZTE Axon 7.
	 */
	class ZteAxon7: public Device
	{
	public:
		//Pointer of itself
		/**
		 ...
		 */
		typedef std::shared_ptr<ZteAxon7> ptr;
